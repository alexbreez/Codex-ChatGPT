...
from src.models import DecisionRecord, PageFact, Recommendation, RuleEvaluation, SignalFinding, VisitFact
...
def run_pipeline(input_rows: list[dict[str, object]], visits: list[dict[str, object]] | None = None, config_path: Path = Path("src/config/config.yaml"), output_dir: Path | None = None, limitations: list[str] | None = None) -> tuple[list[PageFact], list[SignalFinding], list[Recommendation]]:
...
def run_pipeline_from_facts(pages: list[PageFact], visits: list[VisitFact] | None = None, config_path: Path = Path("src/config/config.yaml"), output_dir: Path | None = None, limitations: list[str] | None = None) -> tuple[list[PageFact], list[SignalFinding], list[Recommendation], list[DecisionRecord]]:
