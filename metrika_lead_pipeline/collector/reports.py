...
class MetrikaReportCollector:
    ...
    def collect_page_sources(self, date1: str, date2: str, filters: str | None = None) -> list[SourceFact]:
        ...
        payload = self.client.request(["ym:s:visits"], ["ym:s:startURL", "ym:s:lastsignTrafficSource"], date1, date2, filters)
    ...
    def collect_all(self, date1: str, date2: str, filters: str | None = None) -> NormalizedMetrikaData:
        ...
        return self.normalizer.merge(pages, entry, sources, visits, queries, goals, devices, regions, self.limitations, page_sources=page_sources)
